...
`;Se(De);Y.render=Le;const Ie={class:"relative h-full"},Te={class:"px-4 pt-5 relative"},Oe={class:"flex items-center pb-4 space-x-2"},Fe=s("p",{class:"text-xs text-gray-500 animate-none"},"Je d\xE9sire \xEAtre livr\xE9(e)?",-1),Be={class:"space-y-3 overflow-y-auto"},_e=s("img",{src:"https://primefaces.org/cdn/primevue/images/galleria/galleria7.jpg",alt:"Image",class:"rounded-lg w-14 h-14"},null,-1),ze={class:"px-4"},Pe={class:"prose prose-red text-xs"},Ve={class:"space-x-2"},Ae=["onClick"],We={class:"text-xs rounded-xl px-3 py-1"},He=["onClick"],Ne=s("div",{class:"flex w-full rounded-lg overflow-clip h-32 justify-center text-center"},[s("p",{class:"text-xs text-gray-300"},"vous \xEAtes \xE0 la fin de la liste ")],-1),Re={class:"flex bg-white w-screen shadow-teal-300 items-center h-16 justify-center snackShadow"},je={class:"pr-4 pl-4"},qe={class:"w-full justify-center"},Me=s("p",null,"Total",-1),Ue=s("div",{class:"pr-4 pl-4 bg-black h-full w-16 text-white items-center flex justify-center"},[s("p",{class:"text-xs"},"Valider")],-1),Xe={class:"flex flex-col space-y-2"},Ye=s("p",{class:"text-xs"},"Parce que vous avez accept\xE9 d'\xEAtre livr\xE9",-1),$e=ie({__name:"command",setup(e){const t=se(),i=S(!1),l=ne(),o=le(),n=de(),a=S(!1),r=S(0),d=S([]);function f(){n.currentOrder.forEach(p=>{const y={item:p,quantity:1},w=p.price;r.value+=w,d.value.push(y)})}async function b(){if(i.value){a.value=!0;return}else await u()}async function u(){l.success("Votre commande a \xE9t\xE9 prise en compte"),a.value=!1}function E(){t.back()}function K(p){d.value[p].quantity++,r.value+=d.value[p].item.price}function Z(p){d.value[p].quantity!==1&&(d.value[p].quantity--,r.value-=d.value[p].item.price)}function $(p){const y=p.quantity*p.item.price;r.value-=y,P.remove(d.value,{item:p.item}),P.remove(n.currentOrder,{id:p.item.id})}return f(),(p,y)=>{const w=R("v-icon");return g(),m("div",Ie,[s("div",{class:"text-lg p-4 border-b border-black",onClick:E},[v(w,{name:"fa-chevron-left"}),B("Mes commandes ")]),s("div",Te,[s("div",Oe,[v(D(U),{modelValue:i.value,"onUpdate:modelValue":y[0]||(y[0]=h=>i.value=h),binary:!0,class:""},null,8,["modelValue"]),Fe]),s("div",Be,[(g(!0),m(oe,null,ae(d.value,(h,I)=>(g(),m("div",{class:"flex justify-start items-start px-4 py-2 bg-white border relative w-full rounded-lg overflow-clip",key:I},[_e,s("div",ze,[s("p",null,[B(k(h.item.name)+" ",1),s("span",null,k(h.item.price)+" XOF",1)]),s("p",Pe,k(h.item.description),1),s("div",Ve,[s("span",{class:"text-xs rounded-xl px-3 py-1",onClick:z=>Z(I)},[v(w,{name:"fa-minus"})],8,Ae),s("span",null,k(h.quantity),1),s("span",We,[v(w,{name:"fa-plus",onClick:z=>K(I)},null,8,["onClick"])])])]),s("span",{onClick:z=>$(h)},[v(w,{name:"fa-regular-times-circle"})],8,He)]))),128)),Ne])]),s("div",{class:"bottom-0 fixed border border-black",onClick:b},[s("div",Re,[s("div",je,[v(w,{name:"fa-dollar-sign"})]),s("div",qe,[Me,s("p",null,k(r.value)+" FCFA ",1)]),Ue])]),v(D(Y),{visible:a.value,"onUpdate:visible":y[2]||(y[2]=h=>a.value=h),modal:""},{default:O(()=>[s("div",Xe,[Ye,F(s("input",{type:"text",class:"bg-gray-100 px-4 py-2 rounded placeholder:text-xs focus:border-none","onUpdate:modelValue":y[1]||(y[1]=h=>D(o).client.location=h),placeholder:"Entrez le nom de votre quartier ou de votre localit\xE9"},null,512),[[re,D(o).client.location]]),s("button",{class:"bg-black py-3 rounded text-white text-xs",onClick:u}," Valider")])]),_:1},8,["visible"])])}}});export{$e as default};
