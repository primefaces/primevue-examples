        ...
        computed: {
            ...
            allSelected() {
                return this.selectAll !== null
                    ? this.selectAll
                    : utils.ObjectUtils.isNotEmpty(this.visibleOptions) && this.visibleOptions.filter((option) => !this.isOptionDisabled(option)).every((option) => this.isOptionGroup(option) || this.isValidSelectedOption(option));
            },
            hasSelectedOption() {
